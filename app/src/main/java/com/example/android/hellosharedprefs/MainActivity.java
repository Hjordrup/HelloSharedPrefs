...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Initialize sharedPrefMember
        mPreferences = getSharedPreferences(sharedPrefFile, MODE_PRIVATE);


        //GetInt takes two values one for the key value and one for a default value if non other can be found.
        mCount = mPreferences.getInt(COUNT_KEY, 0);

       //Set textview to value.
        mShowCountTextView.setText(String.format("%s", mCount));


      //Assign the mColor varoable with the correct color.
      mColor = mPreferences.getInt(COLOR_KEY, mColor);




      //Set the textViews Color.
    ...
    public void reset(View view) {
        ...
        //Create a editor to edit the sharedPref.
        SharedPreferences.Editor preferencesEditor = mPreferences.edit();

        //Clear former SharedPref
